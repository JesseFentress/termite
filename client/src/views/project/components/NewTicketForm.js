            ...
            <form onSubmit={formik.handleSubmit}>
                <div className="d-flex justify-content-between">
                    ...
                    <div className="form-floating">
                        ...
                        />
                        <label htmlFor="datePickerInput" id="datePickerLabel">Deadline</label>
                    </div>
                    <div className="form-floating col-3">
                    <select className="form-select mb-3" aria-label="Default select example" id="priority" value={formik.values[3]} onChange={formik.handleChange}>
                        <option defaultValue value="1">Low</option>
